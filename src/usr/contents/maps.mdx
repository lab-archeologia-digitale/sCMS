...
import MaplibreZotero from "./examples/maplibre-zotero-map2onto.mdx"
import MaplibreEdr from "./examples/maplibre-edr-map2onto.mdx"
...
[Open in new page](./examples/maplibre-zotero-map2onto)

<MaplibreZotero />

[Open in new page](./examples/maplibre-edr-map2onto)
